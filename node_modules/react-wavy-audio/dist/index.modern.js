import React__default, { createContext, createElement, useRef, useState, useEffect, Fragment } from 'react';
...
FaPause.displayName = "FaPause";
var FaPlay = function (props) {
...
function Player(props) {
  var _props$playBackSpeedO;

  var waveformRef = useRef();
  var trackRef = useRef();
  ...
  var _useState2 = useState(false),
      playingAudio = _useState2[0],
      setPlayingAudio = _useState2[1];

  var _useState3 = useState(1),
      playBackSpeed = _useState3[0],
      setPlayBackSpeed = _useState3[1];

  var playBackSpeedOptions = (_props$playBackSpeedO = props.playBackSpeedOptions) != null ? _props$playBackSpeedO : [0.5, 1, 1.2, 1.5, 2];

  var playAudio = function playAudio() {
    if (!props.hideWave) waveSurfer.play();else trackRef.current.play();
    setPlayingAudio(true);
  };

  var pauseAudio = function pauseAudio() {
    if (!props.hideWave) waveSurfer.pause();else trackRef.current.pause();
    setPlayingAudio(false);
  };

  var changePlaybackSpeed = function changePlaybackSpeed() {
    var newSpeed = playBackSpeed === 4 ? 0 : playBackSpeed + 1;
    setPlayBackSpeed(newSpeed);
    trackRef.current.playbackRate = playBackSpeedOptions[newSpeed];
  };

  var seekAudioFifteenSeconds = function seekAudioFifteenSeconds(ahead) {
    if (ahead) trackRef.current.currentTime += 15;else trackRef.current.currentTime -= 15;
  };

  useEffect(function () {
    if (waveformRef.current && trackRef.current && !props.hideWave) {
      var wavesurfer = props.waveStyles ? WaveSurfer.create(_extends({}, props.waveStyles, {
        container: "#waveform",
        responsive: true,
      ...
      props.waveJson ? wavesurfer.load(trackRef.current) : wavesurfer.load(trackRef.current, props.waveJson);
      wavesurfer.on("ready", function () {
        setWaveSurfer(wavesurfer);

        if (typeof props.getWaveSurferInstance === 'function') {
          props === null || props === void 0 ? void 0 : props.getWaveSurferInstance(waveSurfer);
        }

        wavesurfer.zoom(props.zoom);
      });

      if (props === null || props === void 0 ? void 0 : props.events) {
        Object.entries(props.events).map(function (_ref) {
          var key = _ref[0],
              value = _ref[1];
  ...
  }, [props.audioUrl, props.hideWave, props.waveStyles, props.waveJson, props.zoom]);
  return /*#__PURE__*/React__default.createElement(Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    style: props.containerStyles ? _extends({
      display: "flex",
      flexDirection: "row"
  ...
  }, !props.hideImage && /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("img", {
    src: props.imageUrl,
    alt: "Audio logo",
    style: props.imgStyles ? _extends({}, props.imgStyles) : {
      maxWidth: "150px"
    }
  ...
  }, /*#__PURE__*/React__default.createElement("div", null, !props.hideWave && /*#__PURE__*/React__default.createElement("div", {
    ref: waveformRef,
    id: "waveform"
  ...
  }, /*#__PURE__*/React__default.createElement(FaUndo, {
    style: {
      margin: "20px",
      cursor: "pointer"
    },
    onClick: function onClick() {
      return seekAudioFifteenSeconds(false);
    }
  }), " ", playingAudio ? /*#__PURE__*/React__default.createElement(FaPause, {
    style: {
      margin: "20px",
      cursor: "pointer"
    },
    onClick: function onClick() {
      return playingAudio ? pauseAudio() : playAudio();
    }
  }) : /*#__PURE__*/React__default.createElement(FaPlay, {
    style: {
      margin: "20px",
      cursor: "pointer"
    },
  ...
  }, playBackSpeedOptions[playBackSpeed], "x"), /*#__PURE__*/React__default.createElement(FaRedo, {
    style: {
      margin: "20px",
      cursor: "pointer"
    },
    onClick: function onClick() {
      return seekAudioFifteenSeconds(true);
    }
  })))));
}
